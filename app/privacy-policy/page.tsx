              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      When you create an account with Bear Watch, we collect
                      your email address and any additional information you
                      choose to provide, such as your blood group and a
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      , we collect your current location to generate a message
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <h3>Usage Information</h3>
                    <p>
                      We analyze usage data to improve the app&apos;s features
                      and performance.
                    </p>
                  </li>
                </ul>
