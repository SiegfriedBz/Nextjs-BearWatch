    ...
    <>
      ...
      <PageLayout>
        <div className='layout-gradient align-center flex flex-col space-y-4'>
          <h2 className='text-center text-3xl'>About Bear Watch</h2>
          ...
          <div className='px-2'>
            <p>
              ...
              , our mission is to empower outdoor enthusiasts and adventurers
              with a tool that can make their wilderness experiences safer and
              more enjoyable.
            </p>
            <p>
              We understand that exploring the wild can sometimes be
              unpredictable, and our goal is to provide a helping hand when you
              need it most.
            </p>
            ...
            <ul>
              <li>
                ...
                <p>
                  ...
                  developed to showcase web development skills and may not have
                  the full range of features or security measures found in
              ...
              <li>
                ...
                <p>
                  ...
                  may not adhere to the same rigorous security and privacy
                  standards as production apps. Use this app with the
                  understanding that it may not meet the same data protection
                  and privacy practices required for operational applications.
                </p>
              </li>
              <li>
                <h3>No Guarantee</h3>
                <p>
                  <span className='font-semibold italic text-warning dark:text-warning-light'>
                    Bear Watch does not guarantee your safety or the
              ...
              <li>
                ...
                <p>
                  ...
                  should not be used for genuine safety or emergency situations.
                  It is not intended to provide emergency services or replace
                  the need for professional assistance in outdoor or wilderness
                  settings.
                </p>
              </li>
            </ul>
